...
cdef complex spectral0(double w, double t): return 0 if (w > -1e-4 and w < 1e-4) else (w > 0) * (4* w**3) / (3*1*10**3)* (1 + exp(-1.0*1*w)) /           (1-exp(-1.0*1*w))+ (w < 0) * (4* w**3) / (3*1*10**3)* exp(1.0*1*w) /             (1-exp(1.0*1*w))
