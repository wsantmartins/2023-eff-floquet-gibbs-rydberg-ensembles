...
def square_wave(t):
    t_mod_T = t % tau 
    if 0 <= t_mod_T < tau/2:
        # Behavior for the first quarter of the period [0, T/2)
        result = 1  # Replace this with your desired value or function   
    else:
        # Behavior for the fourth quarter of the period [T/2, T)
        result = -1 
    return result 
...
#periodic detuning
#sw_itm = "np.sign(np.sin({}*t))"

#periodic Rabi frequency
...
file_name = f'C:\\Users\\wsant\\OneDrive\\Dokumente\\2023ryd_eng_repo\\codes\\python\\many_body\\data\\fidelity N = {N}, w = {omega_d}'
