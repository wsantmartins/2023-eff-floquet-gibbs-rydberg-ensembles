...
V_values = [-4, -3.5, -3 ,-2.5, -2.0, -1.5, -1.0, -0.5, 0, 0.5, 1.0, 1.5, 2.0, 2.5]
fidelity_ss = []
td_ss = []
...
plt.plot(V_values, fidelity_ss, marker='o')

fid_file = f'C:\\Users\\wsant\\OneDrive\\Dokumente\\2023ryd_eng_repo\\codes\\python\\periodic_detuning\\interaction_effect\\data\\ll_f_N={N}_w={omega_d}_Nf={Nf}'

np.savetxt(fid_file, np.c_[V_values, fidelity_ss])
